...
public final class TweetDao_Impl implements TweetDao {
  ...
  public TweetDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTweet = new EntityInsertionAdapter<Tweet>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `Tweet` (`id`,`body`,`createdAt`,`userId`,`timeStamp`) VALUES (?,?,?,?,?)";
      }
  ...
  public List<TweetWithUser> recentItems() {
    final String _sql = "SELECT Tweet.body AS tweet_body, Tweet.createdAt AS tweet_createdAt, Tweet.id AS tweet_id, User.* FROM Tweet INNER JOIN User ON Tweet.userId = User.id ORDER BY Tweet.createdAt DESC LIMIT 250";
